#Program Matematika(Perkalian, Penjumlahan, dan pengkurangan)Matriks Menggunakan Array By Ardhi Ramadhani
#ARDHI RAMADHANI - 50419978 - 1IA07

print("Operasi Perkalian, Penjumlahan, dan pengKurangan Pada Matriks")
